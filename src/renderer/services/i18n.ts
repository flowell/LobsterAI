...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    sendMessageShortcutEnter: '按 Enter 发送',
    sendMessageShortcutCtrlEnter: '按 Ctrl+Enter 发送',
    sendMessageShortcutCmdEnter: '按 ⌘+Enter 发送',
    sendMessageShortcutCustom: '自定义快捷键',
    close: '关闭',
  ...
  en: {
    ...
    sendMessageShortcutEnter: 'Press Enter to send',
    sendMessageShortcutCtrlEnter: 'Press Ctrl+Enter to send',
    sendMessageShortcutCmdEnter: 'Press ⌘+Enter to send',
    sendMessageShortcutCustom: 'Custom Shortcut',
    close: 'Close',
